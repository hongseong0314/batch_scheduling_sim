...
| Production boundary | Operation registry, source key mapping, ingestion contracts, production schema/data-quality diagnostics, canonical twin replay/genealogy, action proposal boundary |
