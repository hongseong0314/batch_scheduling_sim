...
|---|---|
| `sandox/semiconductor_ai_mes_final_design.md` | Historical full MES design draft. Superseded by the active sequence in `00_INDEX.md`. |
| `sandox/mes_frontend_ux_plan.md` | Historical frontend UX plan. Superseded by `08_UI_CONTROL_ROOM_SPEC.md`. |
| `docs/ai-mes/archive/08_PRODUCT_UI_FOUNDATION_V1.md` | Historical product UI foundation note. Folded into `08_UI_CONTROL_ROOM_SPEC.md`. |
| `DESIGN.md` | Root design rules. Still useful for UI styling, summarized into `08_UI_CONTROL_ROOM_SPEC.md`. |
...
- The active reading sequence is now maintained in `00_INDEX.md`; this archive
