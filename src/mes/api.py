...
from src.mes.runtime.factory_twin_api import build_factory_twin_router
...
from src.mes.ui.assets import STATIC_ROOT


context = MESAPIContext()
app = FastAPI(title="Manufacturing AI MES MVP API", version="0.2.0")
app.state.context = context
app.mount("/static/mes", StaticFiles(directory=STATIC_ROOT), name="mes-static")
...
app.include_router(build_factory_twin_router(context))
